...
class ItemMock {
  List<Item> getLAllItems() {
    List<Item> items = new List<Item>();
    Item item = new Item();
    item.id = 1;
    item.title = "Machu Pichu";
    item.description = "Se encuentra en Perú";
    item.image =
    ...
    item.description = "Se encuentra en Cuba";
    item.image =
    ...
    item = new Item();
    item.id = 3;
    item.title = "Torre Eiffel";
    item.description = "Se encuentra en Francia";
    item.image =
  ...
  List<Item> getLAllCharacterItems() {
    List<Item> items = new List<Item>();
    Item item = new Item();
    item.id = 1;
